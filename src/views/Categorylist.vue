<template>
    <div>
      ...
      <el-table-column label="操作">
            <template slot-scope="scope">
            <el-button @click="modifyCategery(scope.row)"  size="small" style="margin-right:10px;">修改名称</el-button>
            <router-link :to="`/category/index/${scope.row.id}`">
...
export default {
  ...
  data() {
    return {
      parentCategoryId:this.$route.CategoryId || 0,
      loading:true,
      cur_page: 1,
      totalCount: 0,
      dataArr:[],
